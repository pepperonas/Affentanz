...
from PyQt6.QtGui import QAction, QColor, QPalette, QShortcut, QKeySequence
...
from utils import (load_settings, save_settings, get_default_tesseract_path,
                 init_config_directories, update_last_directory, get_last_directory,
...
class MainWindow(QMainWindow):
	...
	def __init__(self):
		...
		# Konfigurationsverzeichnisse initialisieren
	...
	def load_workflow(self):
		...
		# Immer das Workflows-Verzeichnis als Startverzeichnis verwenden
		# Dateiauswahldialog
		workflows_dir = get_workflows_directory()
		filename, _ = QFileDialog.getOpenFileName(
			self, "Workflow laden", workflows_dir, "JSON-Dateien (*.json)"
		)
	...
	def save_workflow_as(self):
		...
		filename, _ = QFileDialog.getSaveFileName(
			self, "Workflow speichern", workflows_dir, "JSON-Dateien (*.json)"
		)
